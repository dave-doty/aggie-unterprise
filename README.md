...
If you don't want to install Python, you can download a pre-compiled version of aggie-report for [Windows](dist_win/aggie_report.exe?raw=1) or [Linux](dist_linux/aggie_report?raw=1).